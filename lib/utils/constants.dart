...
// theme
const tCuppingOrange50 = const Color(0xFFEC9762);
const tCuppingOrange100 = const Color(0xFFFABF7C);
const tCuppingBrown50 = const Color(0xFFBCB0A1);
const tCuppingBrown100 = const Color(0xFF8B8175);
const tCuppingBlue100 = const Color(0xFF214254);
const tCuppingBlack = const Color(0xFF121B22);
const tCuppingWhite = const Color(0xFFFFFFFF);