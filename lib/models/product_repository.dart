...
class ProductRepository {
  static List<dynamic> loadProducts(ProductType prodType) {
    ...
    if (prodType == ProductType.TAZAS) {
      return <ProductCups>[
        ProductCups(
          productTitle: "Taza normal",
          productDescription: "Taza de color solido",
          productColor: ProductColor.Blue,
          productImage: "http://www.pngall.com/wp-content/uploads/2/Mug-PNG-Pic.png",
          productAmount: 0,
        ),
        ProductCups(
          productTitle: "Taza con icono",
          productDescription:
              "Taza con iconos impresos. Disponible en varios colores",
          productColor: ProductColor.Blue,
          productImage: "https://i.imgur.com/QQnw45k.png",
          productAmount: 0,
        ),
        ProductCups(
          productTitle: "Taza con frase",
          productDescription:
              "Taza con frase impresa. Disponible en varios colores",
          productColor: ProductColor.Blue,
          productImage: "https://i.imgur.com/qyJhB8K.png",
          productAmount: 0,
        ),
        ProductCups(
          productTitle: "Taza fea",
          productDescription:
              "Taza toda fea que se dibujó con las patas en Paint como en 30 segundos",
          productColor: ProductColor.Blue,
          productImage: "https://i.imgur.com/LLCgawA.png",
          productAmount: 0,
        ),
        ProductCups(
          productTitle: "Taza anime",
          productDescription: "Taza toda owo para servir awa de uwu",
          productColor: ProductColor.Blue,
          productImage: "https://i.imgur.com/eN1W3CL.png",
          productAmount: 0,
        ),
      ];
    }
